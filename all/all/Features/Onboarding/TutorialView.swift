        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                TabView(selection: $viewModel.currentPage) {
                    // Écran 1: "Tout ce dont tu as besoin, près de chez toi."
                    TutorialPage(
                        icon: "star.fill",
                        iconColor: .yellow,
                    ...
                    // Écran 2: "Le local, mais plus accessible."
                    TutorialPage(
                        icon: "",
                        iconColor: .green,
                    ...
                    // Écran 3: "Seulement ce qui compte pour toi."
                    TutorialPage(
                        icon: "bell.fill",
                        iconColor: .yellow,
                    ...
                    // Écran 4: "Les bonnes adresses, les bonnes infos... au bon moment."
                    TutorialPage(
                        icon: "map.fill",
                        iconColor: .blue,
