                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 12) {
                        HStack(spacing: 4) {
                            ...
                            ZStack {
                                Circle().fill(Color.appRed).frame(width: 28, height: 28)
                                Circle().fill(Color.appRed.opacity(0.6)).frame(width: 24, height: 24)
                                Circle().fill(Color.appRed.opacity(0.3)).frame(width: 20, height: 20)
                            }
                            Text("IN")
                                .font(.system(size: 40, weight: .bold, design: .rounded))
                                .foregroundColor(.white)
